function chat -d 'chat.fish'
  ...
  # default model
  set -l DEFAULT_MODEL gpt-3.5-turbo
  ...
  # url
  set -l url https://api.openai.com/v1
  ...
  set -l frequency_txt 'Number between -2.0 and 2.0; positive values penalize tokens on frequency (default: 0)'
  set -l help_txt 'Print this message and exit'
  set -l max_tokens_txt 'Integer of maximum tokens in response (default: null)'
  set -l model_txt "The model to use for completion (default: $DEFAULT_MODEL)"
